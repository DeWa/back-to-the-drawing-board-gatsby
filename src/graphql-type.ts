...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___sources'
...
export type ArchiveQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id' | 'excerpt' | 'timeToRead'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'date'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'category' | 'sources'>> }
      ) }> } };

export type NotesQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type NotesQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id' | 'excerpt' | 'timeToRead'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'date'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'category' | 'sources'>> }
      ) }> } };
...
export type CategoryPageQuery = { allMarkdownRemark: (
    ...
    & { edges: Array<{ node: (
        ...
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'date'>>, frontmatter?: Maybe<(
...
export type ListingQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id' | 'excerpt' | 'timeToRead'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'date'>>, frontmatter?: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'tags' | 'date' | 'category'>
          & { cover?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> }
        )> }
      ) }> } };

export type NoteBySlugQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


export type NoteBySlugQuery = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'category' | 'sources'>>, fields?: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'date'>> }
  )> };
...
export type BlogPostBySlugQuery = { markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<(
      ...
      & { cover?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> }
    )>, fields?: Maybe<Pick<MarkdownRemarkFields, 'slug' | 'date'>> }
  )> };
